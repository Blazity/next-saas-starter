  ...
  return (
    <Wrapper>
      <Form onSubmit={handleSubmit(onSubmit)}>
        ...
        <InputGroup>
          <InputStack>
            {errors.name && <ErrorMessage>Date</ErrorMessage>}
            <Input placeholder="Date" id="name" disabled={isDisabled} {...register('name', { required: true })} />
          </InputStack>
          <InputStack>
            {errors.email && <ErrorMessage>Email adresinizi </ErrorMessage>}
